...
public:
   ...
   // void initializeFeatures(int nFeatures, int keyIndex, Calibration *calib);
    ...
    std::vector<KeyFrame*> neighborKeys;
    Image2 rgbImage;
...
void getSearchBound(KeyFrame *key0, KeyFrame *key1, float x, float y, float searchBound, Calibration &calib, float *p1, float *p2);
void getSearchBound(KeyFrame *key0, KeyFrame *key1, float *p3d, float searchBound, Calibration &calib, float *p1, float *p2);
