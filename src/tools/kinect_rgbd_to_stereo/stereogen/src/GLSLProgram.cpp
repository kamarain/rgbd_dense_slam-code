...
GLSLProgram::GLSLProgram(const char *vsource, const char *gsource, const char *fsource,
                         GLenum gsInput, GLenum gsOutput, int nVertices)
{
    mProg = compileProgram(vsource, gsource, fsource, gsInput, gsOutput,nVertices);
}
                            ...
                            GLenum gsInput, GLenum gsOutput, int nVertices)
{
    ...
    if (gsource)
    {
        ...
        glProgramParameteriEXT(program, GL_GEOMETRY_VERTICES_OUT_EXT, nVertices);
    }
